...
class ChatManager:
    ...
    def process_user_message(
        ...
        if use_memory:
            mem = self._memory.get_last_n_messages_as_string(user_id, self._default_chat_id, mem_length)
        ...
        if use_memory:
            self._memory.add_message(user_id, self._default_chat_id, message, "<USER>")
            self._memory.add_message(user_id, self._default_chat_id, response, "<ASSISTANT>")
        return response
